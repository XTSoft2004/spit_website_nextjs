...
export default function TuyenThanhVien() {
    ...
    const handleReg = async () => {
        if (dateNow >= dateStart && dateNow <= dateEnd)
            document.getElementById('sec-reg-form')?.scrollIntoView({ behavior: 'smooth' });
    }
        ...
        <>
            {(dateNow >= dateStart && dateNow <= dateEnd) ?
                (
                    <>
                        <div id="sec-1" className="position-relative">
                            <div className="d-flex flex-column justify-content-center align-items-center" style={{ width: '100%', height: '100%' }}>
                                <img className='w-100 h-100' src='/images/background/backgroundTuyenThanhVienOpenReg.jpg' alt="background"></img>
                                <div className="position-absolute top-0 end-0 d-flex justify-content-end align-items-center" style={{ width: '100%', height: '100%' }}>
                                    <div className="me-3">
                                        <img style={{ width: 250, height: 250 }} src='/images/logo/logoSPIT.png' alt="logo"></img>
                                    </div>
                                </div>
                                <div className="ms-5 position-absolute top-0 start-0 d-flex justify-content-start align-items-center" style={{ width: '100%', height: '100%' }}>
                                    <div className="w-50">
                                        <h1 className="text-white" style={{ fontWeight: 'bold', fontSize: '90px', textTransform: 'uppercase' }}>Tuyển thành viên</h1>
                                        <p className="text-white mb-3" style={{ fontSize: '20px', textTransform: 'uppercase' }}><b>Thời gian mở đơn:</b> 01/09/2024 - 06/09/2024</p>
                                        <a href="#reg-form">
                                            <Button style={{ width: '200px', height: '50px', borderRadius: '20px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.25)' }} onClick={handleReg}>
                                                <b>ĐĂNG KÝ NGAY</b>
                                            </Button>
                                        </a>
                                    </div>
                        ...
                        <div id="sec-2" className="py-4">
                            <Container className="mb-2">
                                <Row className="mb-2">
                                    <Col>
                                        <a style={{ fontWeight: 'bold', fontSize: '30px', borderTopLeftRadius: '25px', borderBottomRightRadius: '25px' }}>Một số thông tin</a>
                                    </Col>
                                </Row>
                                <div className="mb-3" style={{ width: '20%', borderBottom: '4px solid white' }}></div>
                                <Row>
                                    <Col sm={4}>
                                        <a style={{ fontWeight: 'bold', fontSize: '24px' }}>Đối tượng tham gia</a>
                                    </Col>
                                    <Col sm={8}>
                                        <p>Sinh viên năm 1, 2, 3 đang học ngành Công nghệ thông tin, Kỹ thuật phần
                                            mềm hoặc các ngành khác có liên quan tại trường Đại học Khoa học, Đại
                                            học Huế.</p>
                                        <p className="mb-3">- Đối với sinh viên năm 1: Đạt điểm A học phần Nhập môn lập trình. <br></br>
                                            - Đối với sinh viên năm 2, 3: Đạt điểm A học phần Nhập môn lập trình và
                                            Kỹ thuật lập trình.</p>
                                    </Col>
                                </Row>
                                <div className="mb-4" style={{ borderBottom: '2px solid white' }}></div>
                                <Row>
                                    <Col sm={4} >
                                        <a style={{ fontWeight: 'bold', fontSize: '24px' }}>Hình thức tuyển thành viên</a>
                                    </Col>
                                    <Col sm={8} >
                                        <p>Gồm có 2 vòng: vòng điền form và vòng phỏng vấn.</p>
                                        <p>- Vòng điền form: Ứng viên điền vào form đăng ký ở phía dưới. <br></br>
                                            - Vòng phỏng vấn: Những ứng viên thể hiện tốt ở vòng điền form sẽ được nhận email mời tham gia vòng phỏng vấn trực tiếp.</p>
                                        <p className="mb-3">Sau khi kết thúc 2 vòng, kết quả tuyển thành viên sẽ được thông báo qua
                                            email mà các bạn đã điền ở form đăng ký.</p>
                                    </Col>
                                </Row>
                                <div className="mb-4" style={{ borderBottom: '2px solid white' }}></div>
                                <Row>
                                    <Col sm={4} >
                                        <a style={{ fontWeight: 'bold', fontSize: '24px' }}>Một số lợi ích</a>
                                    </Col>
                                    <Col sm={8} >
                    ...
                    <div id="sec-1" className="position-relative">
                        <div className="d-flex flex-column justify-content-center align-items-center" style={{ width: '100%', height: '100%' }}>
                            <img className='w-100 h-100' src='/images/background/backgroundTuyenThanhVienCloseReg.jpg' alt="background"></img>
                            <div className="position-absolute top-0 end-0 d-flex justify-content-end align-items-center" style={{ width: '100%', height: '100%' }}>
                                <div className="me-3">
                                    <img style={{ width: 250, height: 250 }} src='/images/logo/logoSPIT.png' alt="logo"></img>
                                </div>
                            ...
                            <div className="ms-5 position-absolute top-0 start-0 d-flex justify-content-start align-items-center" style={{ width: '100%', height: '100%' }}>
                                <div className="w-50">
                                    <h1 className="text-white mb-3" style={{ fontWeight: 'bold', fontSize: '40px', textTransform: 'uppercase' }}>CLB hiện chưa tuyển thành viên.</h1>
                                    <p className="text-white mb-3" style={{ fontSize: '18px' }}>Cảm ơn bạn đã quan tâm đến CLB!<br></br>
                                        Hiện tại, CLB chưa có đợt tuyển thành viên mới.<br></br>
                                        Bạn hãy theo dõi trang Facebook/Website chính thức của CLB
                                        để cập nhật thông tin về các đợt tuyển thành viên sắp tới nhé!</p>
